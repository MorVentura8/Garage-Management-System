...
namespace Ex03.GarageLogic
{
    public abstract class Vehicle
    {
        ...
        // $G$ DSN-999 (-5) According to the requirements, you should have created a GarageVehicle class to store vehicle data in the garage: owner name, owner phone, and vehicle status.
        ...
        // $G$ DSN-006 (-7) Bad Encapsulation. You have many public methods that could be private/internal in your logic.
